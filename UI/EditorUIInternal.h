...
bool CreateEmptyBlueprintAsset(const std::wstring& targetDirectory, std::wstring* createdPath = nullptr);
bool CreateEmptyUIBlueprintAsset(const std::wstring& targetDirectory, std::wstring* createdPath = nullptr);
bool CreateEmptyCppScriptAsset(const std::wstring& targetDirectory, std::wstring* createdSourcePath = nullptr, std::wstring* createdHeaderPath = nullptr, const std::wstring& requestedBaseName = L"");
