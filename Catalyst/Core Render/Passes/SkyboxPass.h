...
public:
    ...
    void Render(ID3D12GraphicsCommandList* cmdList, ID3D12Device* device, Mesh* cubeMesh, Camera& camera, ID3D12DescriptorHeap* bindlessHeap, uint32_t hdrIndex, const DirectX::XMFLOAT4& zenithColor, const DirectX::XMFLOAT4& horizonColor, bool hdrTarget = false);
