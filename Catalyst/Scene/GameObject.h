...
struct GameObject {
    ...
    // 1 = fully rough (matches the previous fixed behaviour), 0 = mirror.
    // Drives both the specular highlight and how strongly raytraced
    // reflections show up on the surface.
