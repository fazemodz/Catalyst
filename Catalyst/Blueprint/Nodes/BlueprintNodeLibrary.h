...
inline constexpr const char* kSwapWidgetNodeId = "UI.SwapWidget";
inline constexpr const char* kOpenLevelNodeId = "Gameplay.OpenLevel";
inline constexpr const char* kPrintLogNodeId = "Debug.PrintToLog";
