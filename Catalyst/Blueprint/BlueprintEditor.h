...
private:
    ...
    struct DrawLayout {
        float width, height;
        float menuBarH, toolBarH, graphTabH, graphToolsH;
        float workspaceTop, paletteW, inspectorW;
        float canvasX, canvasY, canvasW, canvasH;
        float inspectorX, contentBottom;
        float toolY, toolTextY;
        float assetInfoW, assetInfoX;
        float graphToolsY;
        float visibleCenterGraphX, visibleCenterGraphY;
        bool isViewportTab, isConstructionTab, isEventGraphTab;
        bool isUIAsset;
        DWORD now;
    ...
    DrawLayout ComputeLayout(float width, float height) const;
    void DrawMenuToolbar(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L, const GameObject* selectedObject);
    void DrawPalettePanel(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L);
    void DrawInspectorPanel(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L, const GameObject* selectedObject);
    void DrawViewportTab(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L);
    void DrawConstructionTab(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L);
    void DrawEventGraphTab(UIDrawList& dl, UIContext& uiCtx, FontManager& fm, InputManager& im, const DrawLayout& L, const GameObject* selectedObject);
